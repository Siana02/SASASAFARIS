...
const IMAGE_ALTS = [
  "Luxury safari in Kenya — elephants silhouetted at golden sunset in the African bush",
  "Classic Maasai Mara safari landscape with acacia trees — best safari destination in Africa",
  "Elephants in Amboseli National Park safari with Mount Kilimanjaro backdrop",
  "Giraffe on a Kenya safari — custom wildlife experience in the African savanna",
  "Great Migration safari in Maasai Mara — wildebeest crossing the Mara River in Kenya",
  "Lion resting in the Maasai Mara at dusk — African safari experiences",
  "Tsavo East National Park safari — tailor-made safaris in Kenya",
  "Family enjoying a guided safari game drive in Kenya",
  "Romantic sundowner safari in the African bush — luxury safaris Africa",
  "Coastal experience at Watamu beach on the Kenyan coast",
  "Kenyan coastline with turquoise Indian Ocean waters — safari and beach holiday",
  "Great Rift Valley sweeping landscape at sunset — best safari destinations in Africa",
  "Wilderness explorer on a walking safari in Kenya",
  "Safari Blue dhow excursion in the clear waters off Watamu, Kenya",
  "Tsavo East safari at sunset — custom-made safaris in Kenya",
  "Dolphins swimming during a Safari Blue boat trip off the Kenyan coast",
  "Hell's Kitchen rock formation in Marafa Depression, Kenya",
  "Watamu cultural tour showing local Giriama traditions — hidden gems in Watamu",
