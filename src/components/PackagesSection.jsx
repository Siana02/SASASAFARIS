...
const packages = [
  ...
  { id: "amboseli-chyulu", image: Amboseli, badgeClass: "badge-adventure", ctaDetails: "#details-amboseli-chyulu" },
  { id: "family-safari-beach", image: FamilySafari, badgeClass: "badge-family", ctaDetails: "#details-family-safari-beach" },
  { id: "romantic-safari", image: RomanticSafari, badgeClass: "badge-romantic", ctaDetails: "#details-romantic-safari" },
  { id: "coastal-adventure", image: CoastalExperience, badgeClass: "badge-coastal", ctaDetails: "#details-coastal-adventure" }
];
          ...
          {cardsForRender.map((card, i) => (
            ...
            >
              ...
              <div className="package-card-content">
                <h2 className="package-title">{t(`packagesData.${card.id}.title`)}</h2>
                <div className="package-duration">{t(`packagesData.${card.id}.duration`)}</div>
                <div className={`package-badge ${card.badgeClass}`}>{t(`packagesData.${card.id}.badge`)}</div>
                <div className="package-description">{t(`packagesData.${card.id}.description`)}</div>
