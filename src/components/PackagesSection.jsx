    ...
    <div className="packages-wrapper" tabIndex={0} aria-label="Safari & Beach Packages">
      ...
      <article className="package-card active" style={{opacity: 1, pointerEvents: "auto", zIndex: 10}}>
        <div className="package-card-image">
          <img src="/assets/Classic Maasai Mara.jpg" alt="Mara & Tsavo Wildlife Safari - lions and elephants in savannah" />
        </div>
      ...
      <article className="package-card" data-index={2} aria-hidden="true">
        <div className="package-card-image">
          <img src="/assets/Family Safari.jpg" alt="Family Safari & Beach Holiday - family on Diani Beach" />
        </div>
        <div className="package-card-content">
      ...
      <article className="package-card" data-index={3} aria-hidden="true">
        <div className="package-card-image">
          <img src="/assets/Romantic Safari.jpg" alt="Romantic Safari & Honeymoon Escape - couple sunset lodge" />
        </div>
        <div className="package-card-content">
      ...
      <article className="package-card" data-index={4} aria-hidden="true">
        <div className="package-card-image">
          <img src="/assets/Coastal Experience.jpg" alt="Kenyan Coastal Adventure - snorkeling and beach" />
        </div>
        <div className="package-card-content">
