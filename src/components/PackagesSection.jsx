...
// Recommended: spring with lower stiffness/damping, longer duration
const CARD_TRANSITION = { type: "spring", stiffness: 180, damping: 22, duration: 0.65 };
// Alternative: regular ease (uncomment these lines to try it out!)
// const CARD_TRANSITION = { duration: 0.8, ease: "easeInOut" };
...
const PackagesSection = () => {
  ...
  const getCardsForRender = () => {
    ...
    const currentCard = {
      ...
      animate: { opacity: 0.25, x: -CARD_ANIMATION_X * dir * 0.7, scale: 0.94 }, // smoother fade & scale
